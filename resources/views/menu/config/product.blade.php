<div class="box box-primary">
	...
	<form class="form-horizontal MenuForm"  enctype="multipart/form-data">
		...
		@csrf
		<div class="box-body">
			@include('admin.input.inputSelect',['label'=>'Product Group','key'=>'product_term_paginate','type'=>'meta','array'=>$arrayProductGroup])
			@include('admin.input.inputFile',['label'=>'Banner','key'=>'banner_image','width'=>'100%'])
		</div>
