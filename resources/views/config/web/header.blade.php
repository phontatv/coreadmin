<div class='box box-primary'>
	<form  class="form-horizontal ConfigForm" enctype="multipart/form-data">
		...
		<div class="box-body">
			...
			@include('phobrv::input.inputFile',['label'=>'Logo','key'=>'logo_img','width'=>'100px','type'=>'configs'])
			@include('phobrv::input.inputText',['label'=>'ALT Logo','key'=>'logo_alt','type'=>'configs'])
			@include('phobrv::input.inputFile',['label'=>'Favicon','key'=>'favicon','width'=>'50px','type'=>'configs'])
			<hr class="border-light">
			<label class="font16">Footer</label>
			@include('phobrv::input.inputFile',['label'=>'Logo Footer','key'=>'logo_footer_img','width'=>'100px','type'=>'configs'])
		</div>
